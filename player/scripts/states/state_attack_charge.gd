...
@onready var attack_charge_hurt_box: HurtBox = %AttackChargeHurtBox
@onready var attack_charge_spin_hurt_box: HurtBox = %AttackChargeSpinHurtBox
...
@onready var gpu_particles_2d: GPUParticles2D = $"../../Sprite2D/AttackChargeHurtBox/GPUParticles2D"
...
func enter() -> void:
	...
	is_attacking = false
	walking = false
	attack_charge_hurt_box.monitoring = true
...
func exit() -> void:
	attack_charge_hurt_box.monitoring = false 
	attack_charge_spin_hurt_box.monitoring = false
	spin_effect_sprite_2d.visible = false
	gpu_particles_2d.emitting = false
	pass
...
func charge_attack() -> void:
	...
	attack_charge_spin_hurt_box.monitoring = true
